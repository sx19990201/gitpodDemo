...
const RealtimePage: NextPage = () => {
  ...
  return (
    <div className={styles.examplesContainer}>
      <h1>Live Weather</h1>
      <p>
        If you watch the Network Tab / DevTools, you'll see no WebSockets, No
        Subscriptions, No Polling, just a GET request with chunked encoding
        (HTTP 1.1) or a stream (HTTP/2).
      </p>
      <p>
        If you blur (un-focus) the browser window/tab you'll see that the stream
        ends.
      </p>
      <p>
        Once you re-enter the window, the stream re-starts and keepts the UI
        updated.
      </p>
      <p>
      ...
      <p>
        You can change the polling interval by adjusting the "liveQuery" config
        in at{" "}

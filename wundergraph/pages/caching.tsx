...
const JobsPage: NextPage = () => {
  ...
  return (
    <div className={styles.examplesContainer}>
      ...
      <p>
        Have a look at the Network Tab / Devtools, the response is cached up to
        120 seconds whereas after 60 seconds, the Browser cache will be
        invalidated through stale while revalidate.
      </p>
      <p>
      ...
      <p>
        ...
        <code className={styles.code}>
          .wundergraph/wundergraph.operations.ts:55
        </code>
      </p>
      <p>
        The use of the generated client can be found at{" "}
        <code className={styles.code}>pages/caching.tsx:6</code>
      </p>
      <p>
        Additionally, if you re-focus the Browser window/tab you'll see a
        network request kick off to refresh the page.
      </p>
      <ul>
